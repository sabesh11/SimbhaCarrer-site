  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Table sx={{ minWidth: 650,boxShadow: 'none' ,border:'none', }} aria-label="simple table">
        <TableHead sx={{backgroundColor: '#dc3545',color:'aliceblue'}}>
          <TableRow >
            <TableCell sx={{color:'white'}} align='center'>Job Title</TableCell>
            <TableCell align="center" sx={{color:'white'}}>Location</TableCell>
            <TableCell align="center" sx={{color:'white'}}>Posted at</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="center">{dateFormat(
row.updatedAt)}</TableCell>
              <TableCell align="center"><ContentCopyIcon  sx={{color:'#dc3545'}} />&nbsp;&nbsp;&nbsp;&nbsp;<EditIcon sx={{color:'#dc3545'}} onClick={()=>{handleShow1(row)}}/>
              </TableCell>
    ...
    <Button className='mb-3 me-3 rounded-circle'  onClick={handleShow} style={{position:'fixed',bottom:'0',right:'0', backgroundImage: 'radial-gradient( circle farthest-corner at 17.1% 22.8%,  rgba(226,24,24,1) 0%, rgba(160,6,6,1) 90% )',border:'none'}}>
            ...
            <MenuItem key={option.value} value={option.value}>
              {option.label}
                        ...
                        <div className="mt-4 text-center ">
                            <button class="btn w-100 text-white rounded-pill" type="button" style={{ backgroundImage: 'radial-gradient( circle farthest-corner at 17.1% 22.8%,  rgba(226,24,24,1) 0%, rgba(160,6,6,1) 90% )'}} onClick={handleClick}>Add Job</button>
                        </div>
        </Offcanvas.Body>
      </Offcanvas>
        ...
        <div class="mt-4">
              ...
              {option }
                        ...
                        <div class="mt-4">
                            ...
                            id="outlined-basic"
                             label="Job Description" 
                             fullWidth
                            value={singleJobDetail.jobDescription}
                            name='jobDescription'
                            onChange={handleUpdate}
                            slotProps={{
                                    input: {
            ...
            <MenuItem key={option.value} value={option.value}>
              {option.label}
                        ...
                        <div className="mt-4 text-center ">
                            <button class="btn w-100 text-white rounded-pill" type="button" style={{ backgroundImage: 'radial-gradient( circle farthest-corner at 17.1% 22.8%,  rgba(226,24,24,1) 0%, rgba(160,6,6,1) 90% )'}} onClick={updateJobs}>update Job</button>
                        </div>
        </Offcanvas.Body>
      </Offcanvas>
      <ToastContainer />
